  ...
  AnyKeyboard createSymbolsKeyboard(
    ...
    AnyKeyboard keyboard =
        switch (keyboardIndex) {
          case KeyboardSwitcher.SYMBOLS_KEYBOARD_REGULAR_INDEX -> createGenericKeyboard(
              defaultAddOn,
              context,
              ...
              "symbols_keyboard",
              keyboardRowMode);
          case KeyboardSwitcher.SYMBOLS_KEYBOARD_ALT_INDEX -> createGenericKeyboard(
              defaultAddOn,
              context,
              ...
              keyboardRowMode);
          case KeyboardSwitcher.SYMBOLS_KEYBOARD_ALT_NUMBERS_INDEX -> createGenericKeyboard(
              defaultAddOn,
              context,
              ...
              keyboardRowMode);
          case KeyboardSwitcher.SYMBOLS_KEYBOARD_PHONE_INDEX -> createGenericKeyboard(
              defaultAddOn,
              context,
              R.xml.simple_phone,
              R.xml.simple_phone,
              ...
              keyboardRowMode);
          case KeyboardSwitcher.SYMBOLS_KEYBOARD_NUMBERS_INDEX -> createGenericKeyboard(
              defaultAddOn,
              context,
              ...
              keyboardRowMode);
          case KeyboardSwitcher.SYMBOLS_KEYBOARD_DATETIME_INDEX -> createGenericKeyboard(
              defaultAddOn,
              context,
