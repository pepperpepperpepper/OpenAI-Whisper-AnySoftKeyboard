...
/**
 * Small stateless helpers that operate on the current selection/cursor to keep
...
public final class SelectionEditHelper {
  ...
  public static void wrapSelectionWithCharacters(
    ...
    final InputConnection ic = inputConnectionRouter.current();
    if (ic == null) return;
  ...
  public static void toggleCaseOfSelectedCharacters(
    ...
    ic.setComposingText(workspace.toString(), 0);
    inputConnectionRouter.endBatchEdit();
